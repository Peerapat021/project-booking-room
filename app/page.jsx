          ...
          <div className="relative flex h-16 items-center justify-between">
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex space-x-4">
                  ...
                  <a
                    href="#"
                    className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-[#e9cc65] hover:text-white"
                  >
                    รายการห้องประชุม
                  </a>
                  <a
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              <div className="flex space-x-2">
                ...
                <button className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-400">
                  Sign Up
                </button>
              </div>
            </div>
